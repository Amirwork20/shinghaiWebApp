...
export function CategoryProvider({ children }) {
    ...
    switch(type) {
      ...
      case 'sub-category':
        ...
        if (parentInfo?.mainCategory) {
          ...
          newParams.set('main-category-name', parentInfo.mainCategory.category_name)
        }
        ...
        setActiveCategory({
          mainCategory: parentInfo?.mainCategory 
            ? { id: parentInfo.mainCategory._id, name: parentInfo.mainCategory.category_name }
            : { id: null, name: null },
          subCategory: { id, name },
          category: { id: null, name: null },
          search: null
      ...
      case 'category':
        ...
        if (parentInfo?.subCategory) {
          ...
          newParams.set('sub-category-name', parentInfo.subCategory.category_name)
        }
        ...
        setActiveCategory({
          ...
          subCategory: parentInfo?.subCategory
            ? { id: parentInfo.subCategory._id, name: parentInfo.subCategory.category_name }
            : { id: null, name: null },
          category: { id, name },
          search: null
        })
  ...
  const getCurrentCategoryName = () => {
    ...
    if (activeCategory?.subCategory?.name) return activeCategory?.subCategory?.name
    if (activeCategory?.mainCategory?.name) return activeCategory?.mainCategory?.name
    return 'All Products'
  }
