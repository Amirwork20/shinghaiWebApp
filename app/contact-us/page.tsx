      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          <div className="bg-gray-50 p-6 rounded-lg">
            <h2 className="text-xl font-semibold mb-4">Customer Service Hours</h2>
            <p className="text-gray-700">
              The customer care representative is available from 10 am to 8:30 pm (Monday to Saturday).
            </p>
          </div>
